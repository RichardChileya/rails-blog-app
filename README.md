...
**Rails Blog App** is a rails simple blog application for publishing stories and events. 
...
Feel free to check the [issues page](https://github.com/RichardChileya/rails-blog-app/issues).
